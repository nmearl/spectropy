...
PACKAGENAME = metadata.get('package_name', 'spectropy')
DESCRIPTION = metadata.get('description', 'Spectroscopic tools in Python')
AUTHOR = metadata.get('author', 'Steve Crawford, Nicholas Earl, Adam Ginsburg, Erik Tollerud')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'http://github.com/nmearl/spectropy')
